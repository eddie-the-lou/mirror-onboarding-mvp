...
- An API integration with a frontier LLM (Claude or equivalent) for two calls: follow-up question generation during the interview, and insight generation after the final interview response
...
**Implementation note (dynamic follow-ups):** Keep the number of free-response screens fixed per path (A/B: 4, C: 4 including the initial situation prompt, D: 2), but generate the follow-up question dynamically based on what the user just wrote. The goal is to extract the missing specifics needed for a strong insight (sequence of events, what they did next, what they felt, what they avoided, what they’re leaving out). The model should output the next question only — no summaries.
...
**Copy:** "Pick the one that feels closest to your experience."
...
#### Screen 16a: Guided Exploration — Question 1

**Layout:** The selected prompt rephrased as a direct question. Large free-text input field.

Example for "the moment you first knew something had shifted":

**Copy:** "Tell me about that moment. What happened, and what changed inside you? The more detail you share, the more I can see."

**Input:** Free text. Placeholder text to model expected depth: "e.g., We were at dinner and I noticed they got quiet after I mentioned something about the future. I didn't say anything but I could feel the whole energy shift..."

**Minimum character suggestion:** Show a gentle nudge if under 50 characters: "Can you tell me a bit more? The more detail you share, the more I can see."

**Data collected:** `interview.free_responses[0]`

---

#### Screen 17a: Guided Exploration — Question 2

**Layout:** Brief AI acknowledgment of what they wrote (1 sentence, generated via API call or pre-written template), then a follow-up question. Free-text input.

**Copy:** "[Brief acknowledgment.] When you noticed that shift — what did you actually do? Not what you wish you'd done. What happened next?"

**Implementation note:** The acknowledgment can either be a simple API call (send their response, ask for a one-sentence reflection) or a template-based response that references a keyword from their answer. For MVP, a template approach is simpler: "I hear you." or "That's a specific moment." followed by the question. The API approach is better but adds latency.

**Data collected:** `interview.free_responses[1]`

---

#### Screen 18a: Guided Exploration — Question 3

**Copy:** "Has that exact sequence — the shift, followed by what you just described — happened before? In a different relationship or a completely different situation?"

**Data collected:** `interview.free_responses[2]`

---

#### Screen 19a: Guided Exploration — Question 4

**Copy:** "Last question. When you imagine someone who really knows you hearing this story — what part would they say you're leaving out or downplaying?"

**Data collected:** `interview.free_responses[3]`
...
**Copy:** "Pick the one that feels closest to what you're experiencing."
...
#### Screen 16b: Guided Exploration — Question 1

Example for "a moment where you both felt it but neither named it":

**Copy:** "Set the scene for me. Where were you, what was happening on the surface, and what was happening underneath? The more detail you share, the more I can see."

**Data collected:** `interview.free_responses[0]`

---

#### Screen 17b: Guided Exploration — Question 2

**Copy:** "[Brief acknowledgment.] What do you think they were feeling in that moment? And what makes you think that — what were the signals?"

**Data collected:** `interview.free_responses[1]`

---

#### Screen 18b: Guided Exploration — Question 3

**Copy:** "Now — what were you feeling? Not what you thought about their feelings. What was going on inside you, separately?"

**Data collected:** `interview.free_responses[2]`

---

#### Screen 19b: Guided Exploration — Question 4

**Copy:** "If you had said something in that moment — named what was happening — what do you think would have happened? Walk me through what you imagine."
...
#### Screen 16c: Guided Exploration — Question 1

**Copy:** "[Brief acknowledgment.] What's the outcome you're most afraid of here? Not the practical worst case — the emotional worst case."

**Data collected:** `interview.free_responses[1]`

---

#### Screen 17c: Guided Exploration — Question 2

**Copy:** "And what would you normally do in a situation like this? Not the ideal response — your actual default when you're under this kind of pressure."

**Data collected:** `interview.free_responses[2]`

---

#### Screen 18c: Guided Exploration — Question 3

**Copy:** "What's the gap between those two things — what you'd default to and what you wish you'd do instead? What gets in the way?"

**Data collected:** `interview.free_responses[3]`

**Next screen:** Screen 20 (shared).

**Note:** Path C has one fewer guided exploration question than Paths A and B (three free responses after the initial situation prompt, versus four). This is intentional — the initial situation description in Screen 15c serves as the first substantial free response.
...
### Call 1: Insight Generation (fired after final guided exploration)

**Endpoint:** LLM API (e.g., Anthropic Messages API)
...
### Call 2: Report Refinement (fired on Screen 22 feedback)
...
### Optional Call 3: Follow-up Acknowledgments (Screens 17a/b/c)

**If using API-generated acknowledgments** (recommended for quality, adds latency):

**System message:** "You are Mirror. Given the user's response to a question about their life, write a single brief sentence (under 15 words) that acknowledges what they said with specificity. Do not analyze, do not interpret, do not ask a follow-up yet. Just show you heard them. Be specific to what they said — do not use generic acknowledgments like 'thank you for sharing' or 'that sounds difficult.' Reference a specific word or detail from their response."

**User message:** "The user was asked: '[question]' and responded: '[their response]'"

**Parameters:**
- Model: Same or lighter model for speed
- Max tokens: 50
- Temperature: 0.5

**If using template-based acknowledgments** (simpler, faster):

Use a short set of pre-written acknowledgments that feel specific without being generic:
- "That's a clear moment."
- "I can picture that."
- "That detail matters."
- "That's specific — good."

Select based on response length and content keywords. Less ideal than API-generated but eliminates latency.
